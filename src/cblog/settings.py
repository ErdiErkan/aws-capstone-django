...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/erdi/capstone/username')
    password_param = ssm.get_parameter(Name="/erdi/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c75uik59fnk0.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'erdicapstonestatic' # please enter your s3 bucket name
